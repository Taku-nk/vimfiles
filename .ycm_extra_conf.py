...
new_dir = os.path.join(working_dir, r'include')
INCLUDE_DIR = new_dir.replace('\\', '/')
...
'-isystem',
'C:/Program Files (x86)/Microsoft Visual Studio/2019/Community/VC/Tools/MSVC/14.28.29910/lib', 
'-I',
'-std=c++17',
'-I',
INCLUDE_DIR,
